		...
		<div class="leftsidebar_box">
			...
			<c:if test="${sessionScope.user.userNum == 'admin'}">
				...
				<dl class="channel">
					...
					<dl class="channel">
		              	<dt>修改权重</dt>
		                <dd><a href="/OD/user/modifyProperties/?juge=1" target="right">校厅级权重</a></a></dd>
		                ...
		                <dd><a href="/OD/user/modifyAGProperties/?juge=1" target="right">教学正书记/教学正院长</a></a></dd>
		                <dd><a href="/OD/user/modifyDCProperties/?juge=1" target="right">党群副处/行政副处</a></a></dd>
               		</dl>
